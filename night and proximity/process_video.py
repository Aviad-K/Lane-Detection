...
LANE_SEARCH_CONFIG = {
    'L': {
        'top_y':    HORIZON_Y,
        'top_x':    (825, 925),   # Hardcode these for your Tokyo video
        'bottom_x': (475, 675)    # Hardcode these for your Tokyo video
    },
    'R': {
        'top_y':    HORIZON_Y,
        'top_x':    (925, 1025), # Hardcode these for your Tokyo video
        'bottom_x': (1250, 1450)  # Hardcode these for your Tokyo video
    }
}
...
def process_frame(frame: np.ndarray, layer_mode: int = 0, minimal: bool = False) -> tuple:
    ...
    return (view_final, view_mask, view_debug, binary_mask, 
            ...
            car_binary, car_roi_view, None, None)
# =============================================================================
# VIEW MODES
# =============================================================================
